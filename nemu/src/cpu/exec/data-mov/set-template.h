...
#define flagstr seta
make_eflags_helper(r,!cpu.CF,!cpu.ZF)
#undef flagstr

#define flagstr setae
make_eflags_helper(r,!cpu.CF,1)
#undef flagstr
...
make_eflags_helper(r,cpu.CF || cpu.ZF,1)
#undef flagstr
...
#define flagstr setg
make_eflags_helper(r,!cpu.ZF,cpu.SF==cpu.OF)
#undef flagstr

#define flagstr setge
make_eflags_helper(r,cpu.SF==cpu.OF,1)
#undef flagstr
...
make_eflags_helper(r,(cpu.ZF || (cpu.SF!=cpu.OF)),1)
#undef flagstr

#define flagstr setna
make_eflags_helper(r,cpu.CF,cpu.SF)
#undef flagstr
...
make_eflags_helper(r,!cpu.ZF,!cpu.ZF)
#undef flagstr
...
make_eflags_helper(r,!cpu.OF,1)
#undef flagstr

#define flagstr setnp
make_eflags_helper(r,!cpu.PF,1)
#undef flagstr

#define flagstr setns
make_eflags_helper(r,!cpu.SF,1)
#undef flagstr
