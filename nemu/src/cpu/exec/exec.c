...
/* 0x90 */	seto_r_b, setno_r_b, setb_r_b, setnb_r_b,
/* 0x94 */	setz_r_b, setnz_r_b, setbe_r_b, setnbe_r_b,
/* 0x98 */	sets_r_b, setns_r_b, setp_r_b, setnp_r_b, 
/* 0x9c */	setl_r_b, setnl_r_b, setle_r_b, setnle_r_b, 
